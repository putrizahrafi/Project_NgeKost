            ...
            <div class="row justify-content-center">
                <div class="p-5 bg-light rounded-3 col-xl-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="age" class="form-label">Invoice Pembayaran Kos (Diisi oleh Admin)</label>
                            @if ($employee->original_filename)
                                ...
                                <a href="{{ route('employees.downloadFile', ['employeeId' => $employee->id]) }}" class="btn btn-primary btn-sm mt-2">
                                    <i class="bi bi-download me-1"></i> Download Invoice Pembayaran Kos
                                </a>
                            @else
                                <h5>Tidak ada</h5>
                                {{-- <hr><input type="file" class="form-control" name="invoice" id="invoice"> --}}
                            @endif
                        </div>
                        <div>
